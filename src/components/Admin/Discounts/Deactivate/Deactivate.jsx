...
const Deactivate = () => {
	...
	const proceedHandler = async (e) => {
		e.preventDefault();
		await fetch(
			`https://labloco-medical-supplies.herokuapp.com/discounts/${discountId}/deactivate`,
			{
				method: "PUT",
				headers: {
					"Content-Type": "application/json",
				...
				<Col className="p-0 m-0">
					...
					<Modal show={show} onHide={handleClose}>
						<Modal.Header closeButton>
							<Modal.Title>Deactivate a discount</Modal.Title>
						</Modal.Header>
						<Modal.Body>
							<Form className="gap-3 d-flex flex-column">
								<Form.Group>
									<Form.Label>Select discount to deactivate</Form.Label>
									<Form.Select
										value={discount}
